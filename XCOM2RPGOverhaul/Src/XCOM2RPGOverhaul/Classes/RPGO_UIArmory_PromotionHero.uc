class RPGO_UIArmory_PromotionHero extends UIArmory_PromotionHero dependson(X2SoldierClassTemplatePlugin) config(PromotionUIMod);
...
simulated function PopulateData()
{
	...
	local RPGO_UIArmory_PromotionHeroColumn Column;
	...
	{
		Column = RPGO_UIArmory_PromotionHeroColumn(Columns[iRank]);
...
function bool UpdateAbilityIcons_Override(out RPGO_UIArmory_PromotionHeroColumn Column)
{
...
function InitColumns()
{
	...
	for (i = 0; i < numCols; i++)
	{
		Column = Spawn(class'RPGO_UIArmory_PromotionHeroColumn', self);
